...
/*   Updated: 2022/03/28 15:59:37 by eavilov          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_hero_move_right(t_struc *vars)
{
	if (vars->readcont[vars->pos + 1] != '1')
	{
		...
		else if (vars->readcont[vars->pos + 1] == 'E' && vars->itemcount == 0)
			ft_mlx_close(&*vars);
		else if (vars->readcont[vars->pos] == 'E')
		{
			...
			mlx_put_image_to_window(vars->mlx, vars->win, vars->hero, vars->x + 64, vars->y);
			vars->x = vars->x + 64;
			vars->pos++;
			return (0);
		}
...
int		ft_hero_move_down(t_struc *vars, int column)
{
	if (vars->readcont[vars->pos + column + 1] != '1')
	{
		...
		else if (vars->readcont[vars->pos + column + 1] == 'E' && vars->itemcount == 0)
			ft_mlx_close(&*vars);
		else if (vars->readcont[vars->pos] == 'E')
		{
			mlx_put_image_to_window(vars->mlx, vars->win, vars->floor, vars->x, vars->y);
			mlx_put_image_to_window(vars->mlx, vars->win, vars->exit, vars->x - 10, vars->y + 26);
			mlx_put_image_to_window(vars->mlx, vars->win, vars->hero, vars->x, vars->y + 64);
			vars->x = vars->x + 64;
